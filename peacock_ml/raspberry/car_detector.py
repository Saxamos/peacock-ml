...
from peacock_ml.raspberry import PI_PROJECT_PATH


class CarDetector:
    CAR_DISPLAY = open(os.path.join(PI_PROJECT_PATH, 'car.txt')).read()
    NOT_CAR_DISPLAY = open(os.path.join(PI_PROJECT_PATH, 'not_car.txt')).read()
