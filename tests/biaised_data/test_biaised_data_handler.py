...
class TestCreateWeightedMulticlassDataset(unittest.TestCase):
    def test_create_weighted_multiclass_dataset_should_return_expected_weight_by_class_list(self):
        # Given
        n_samples = 500
        n_classes = 3
        ...
        # When
        weight_by_class_list = find_weights_and_compute_score(df_train, df_test, random_state=6)
